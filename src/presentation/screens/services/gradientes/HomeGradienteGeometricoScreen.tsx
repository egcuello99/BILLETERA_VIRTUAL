...
export const HomeGradienteGeometricoScreen = () => {
  const navigation =
    ...
    <View style={{ paddingTop: top }} className="flex-1 bg-slate-800">
      ...
      <View>
        <Text className="text-justify p-2 text-white">
          El Gradiente Geometrico es similar a las anualidades en el sentido que
        ...
        <View className="flex-col">
          <Button
            ...
            onPress={() => navigation.navigate("GradienteGeometrico")}
          >
            <Text className="text-md font-bold text-white">Valor Presente Geometrico</Text>
          </Button>
          {/* <Button
            mode="contained"
            className="bg-purple-700 my-2 mx-2 text-white"
